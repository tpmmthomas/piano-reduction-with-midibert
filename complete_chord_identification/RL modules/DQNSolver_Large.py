...
class DQNSolver:
    def __init__(
        ...
        h2 = Dense(64, activation="ReLU")(state_input)
        ha = Dense(64, activation="ReLU")(h2)
        h3 = Dense(32, activation="ReLU")(ha)
        ...
        h22 = Dense(64, activation="ReLU")(state_input2)
        ha2 = Dense(64, activation="ReLU")(h22)
        h32 = Dense(32, activation="ReLU")(ha2)
    ...
    def run(self):
        ...
        for e in range(self.n_episodes):
            ...
            if replayloss[0] < self.best_loss:
                self.model.save(f"dqnlarge_best_{replayloss[0]}")
                self.best_loss = replayloss[0]
            if e % 100 == 0 or e == self.n_episodes - 1:
                print(e)
                np.save("loss_dqnlarge.npy", np.array(loss))
        return loss
